...
namespace EllipticCurveMultiplication
{
    public partial class MainForm : Form
    {
        ...
        public static List<MethodItem> GetMultiplicationMethodItems()
        {
        ...
        public static Dictionary<CoordinateSystem, string> GetCoordinateSystemItems()
        {
            return new Dictionary<CoordinateSystem, string>
            {
                { CoordinateSystem.Affine, "Афінна" },
                { CoordinateSystem.Projective, "Проективна" },
                { CoordinateSystem.Jacobian, "Якобі" },
                { CoordinateSystem.JacobianChudnovsky, "Якобі-Чудновського" },
                { CoordinateSystem.JacobianModified, "Модифікована Якобі" }
            };
        }
